...
storiesOf('Tabs', module).addDecorator(withKnobs).add('Default', function () {
  return /*#__PURE__*/React.createElement(Tabs, props.tabs(), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-1"
  }, props.tab(), {
    label: "Tab label 1"
  }), /*#__PURE__*/React.createElement("div", {
    className: "some-content"
  }, /*#__PURE__*/React.createElement("p", null, "Content for first tab goes here."))), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-2"
  }, props.tab(), {
    label: "Tab label 2"
  }), /*#__PURE__*/React.createElement("div", {
    className: "some-content"
  }, /*#__PURE__*/React.createElement("p", null, "Content for second tab goes here."))), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-3"
  }, props.tab(), {
    label: "Tab label 3",
    disabled: true
    ...
    className: "some-content"
  }, /*#__PURE__*/React.createElement("p", null, "Content for third tab goes here."))), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-4"
  }, props.tab(), {
    label: "Tab label 4",
    ...
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), /*#__PURE__*/React.createElement(CodeSnippetExample, null))), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-5"
  }, props.tab(), {
  ...
  return /*#__PURE__*/React.createElement(Tabs, _extends({
    type: "container"
  }, props.tabs()), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-1"
  }, props.tab(), {
    label: "Tab label 1"
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "some-content"
  }, /*#__PURE__*/React.createElement("p", null, "Content for third tab goes here."), /*#__PURE__*/React.createElement("p", null, "This example uses the\xA0", /*#__PURE__*/React.createElement(CodeSnippet, {
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), /*#__PURE__*/React.createElement(CodeSnippetExample, null))), /*#__PURE__*/React.createElement(Tab, _extends({
    id: "tab-4"
  }, props.tab(), {
    ...
    className: "some-content"
  }, /*#__PURE__*/React.createElement("p", null, "Content for fourth tab goes here."), /*#__PURE__*/React.createElement(TextInput, {
    light: true,
    id: "sample-input",

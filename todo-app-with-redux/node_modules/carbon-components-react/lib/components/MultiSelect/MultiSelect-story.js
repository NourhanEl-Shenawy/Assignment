...
(0, _react2.storiesOf)('MultiSelect', module).addDecorator(_addonKnobs.withKnobs).add('default', (0, _storybookReadme.withReadme)(_README.default, function () {
  var _props = props(),
      ...
      multiSelectProps = _objectWithoutProperties(_props, ["listBoxMenuIconTranslationIds", "selectionFeedback"]);

  return /*#__PURE__*/_react.default.createElement("div", {
    style: {
      width: 300
    }
  }, /*#__PURE__*/_react.default.createElement(_MultiSelect.default, _extends({}, multiSelectProps, {
    items: items,
  ...
  var _props2 = props(),
      ...
      multiSelectProps = _objectWithoutProperties(_props2, ["listBoxMenuIconTranslationIds", "selectionFeedback"]);
...
}).add('filterable', (0, _storybookReadme.withReadme)(_README.default, function () {
  var _props3 = props(),
      listBoxMenuIconTranslationIds = _props3.listBoxMenuIconTranslationIds,
      selectionFeedback = _props3.selectionFeedback,
      multiSelectProps = _objectWithoutProperties(_props3, ["listBoxMenuIconTranslationIds", "selectionFeedback"]);

  return /*#__PURE__*/_react.default.createElement("div", {
    style: {
      width: 300
    }
  }, /*#__PURE__*/_react.default.createElement(_MultiSelect.default.Filterable, _extends({}, multiSelectProps, {
    items: items,
    itemToString: function itemToString(item) {
      return item ? item.text : '';
    },
